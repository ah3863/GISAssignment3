const SATCData = [
    {
      "location name": "Carrie Bradshaw’s apartment (theoretical)",
      "character": "Carrie",
    ...
    {
      "location name": "Carrie Bradshaw’s apartment (filming location)",
      "character": "Carrie",
      "episode": "Season: 1. Episode: 1 ",
    ...
    {
      "location name": "Louis K. Meisel Gallery",
      "character": "Charlotte",
    ...
    {
      "location name": "St. Patrick’s Cathedral",
      "character": "Carrie",
    ...
    {
      "location name": "Staten Island Ferry",
      "character": "Charlotte",
    ...
    {
      "location name": "Grace Episcopal Church",
      "character": "Charlotte",
    ...
    {
      "location name": "The Central Park Loeb Boathouse",
      "character": "Carrie",
    ...
    {
      "location name": "Soho House New York",
      "character": "Samantha",
    ...
    {
      "location name": "Jefferson Market Garden",
      "character": "Miranda",
    ...
    {
      "location name": "New York Public Library",
      "character": "Carrie",
